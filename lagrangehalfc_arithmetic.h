...
// result = result - poly1*poly2
EXPORT void torusPolynomialSubMulRFFT(TorusPolynomial* result, const IntPolynomial* poly1, const TorusPolynomial* poly2);
// result = poly1*poly2 - result 
EXPORT void torusPolynomialSubMulRFFT2(TorusPolynomial* result, const IntPolynomial* poly1, const TorusPolynomial* poly2);
// new used in mkTFHEkeygen
